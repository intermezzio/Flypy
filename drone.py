...
class Drone:
    ...
    def calc_thrust(self):
        ...
        t_matrix = Vector(x=cos(_psi) * sin(_the) * cos(_phi) + \
                            sin(_psi) + sin(_phi),
                          y=sin(_psi) * sin(_the) * cos(_phi) - \
                            cos(_psi) * sin(_phi),
                          z=cos(_the) * cos(_phi))
    ...
    def calc_cent(self):
        ...
        Returns:
            ...
            centripetal force
        """
        inertia_velocity = Vector(x=self.bf_angular_vel.x * self.m_of_i_xx,
